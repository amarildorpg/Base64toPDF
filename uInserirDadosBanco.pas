...
begin
  ...
  try
    ...
    ShowMessage('Arquivo PDF decodificado e salvo com sucesso em ' + FileName);
  except
    on E: Exception do
...
begin
  ...
  FQuery.Connection := FConexao.dBanco;
 ...
 if (FConectado) and not(FSelectedFolder = '') then
    ...
    try
      ...
      Base64ToPDF(edPastaPdf.Text, LtextoPdf64);
    finally
      FreeAndNil(Base64);
    end;
end;
